        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-2">
            ...
            <Select value={status} onValueChange={onStatusChange}>
              <SelectTrigger className="h-18 w-full border-2 bg-white px-4 py-6 transition-all hover:border-indigo-400 hover:bg-indigo-50 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200">
